...
class AgentEvaluator:
    ...
    def _evaluate_output(
        self, case: EvaluationCase, actual: str
    ...
    async def evaluate_all(
        self, cases: List[EvaluationCase], parallel: bool = False, max_parallel: int = 5
    ) -> EvaluationReport:
        ...
        self.logger.info(
            f"Evaluation complete: {passed}/{len(cases)} passed, avg score: {avg_score:.2f}"
        )
