...
class ADKWorkflow:
    ...
    def __init__(
        self, name: str, description: str = "", tasks: Optional[List[WorkflowTask]] = None
    ):
        self.name = name
    ...
    def from_yaml(cls, path: Path) -> "ADKWorkflow":
        ...
        return cls(
            name=data.get("name", path.stem), description=data.get("description", ""), tasks=tasks
        )
...
class WorkflowExecutor:
    ...
    def _substitute_variables(
        self, prompt: str, inputs: Dict[str, Any], outputs: Dict[str, str]
    ) -> str:
    ...
    async def execute(self, workflow: ADKWorkflow, inputs: Dict[str, Any] = None) -> WorkflowResult:
        """Execute a workflow.
    ...
    async def execute_from_file(
        self, workflow_path: Path, inputs: Dict[str, Any] = None
    ) -> WorkflowResult:
